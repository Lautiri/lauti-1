...
class App(customtkinter.CTk):
    ...
    def btn_total_iva_on_click(self):
     ...
     resultado_final_con_iva =suma_total * iva

     alert("valor con IVA", resultado_final_con_iva)
